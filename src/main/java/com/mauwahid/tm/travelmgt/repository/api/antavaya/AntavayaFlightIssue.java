...
@Component
@Slf4j
public class AntavayaFlightIssue implements FlightIssueInterface {
    ...
    public boolean isReserved(String pnrId){
        ...
        try{
            Map param = AntavayaFlightReservationStatus.translateToParam(flightReservationStatusReq);

            AntavayaFlightReservationStatus antavayaFlightReservationStatus = new AntavayaFlightReservationStatus();
            FlightReservationStatusResponse flightReservationStatusResponse = antavayaFlightReservationStatus.cekStatus(param);
